...
public class StartupBisnis extends Fragment implements MyAdapter.ListItemClickListener {

    private final static String BASE_URL = "http://startupbisnis.com/category/startup-indonesia/";
    private final static String MAIN_CLASS = "post-thumb";
