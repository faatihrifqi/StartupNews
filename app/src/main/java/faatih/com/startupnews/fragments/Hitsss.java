...
public class Hitsss extends Fragment implements MyAdapter.ListItemClickListener {

    private final static String BASE_URL = "http://hitsss.com/startup/";
    private final static String MAIN_CLASS = "entry-title td-module-title";
    ...
    private class DownloadNewsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if(new_doc != null){
                ...
                Elements parentClass = new_doc.getElementsByClass("td_module_10 td_module_wrap td-animation-stack");
                for (Element link : parentClass) {
                    Elements myLink = link.getElementsByClass(MAIN_CLASS);
                    for (Element new_link : myLink) {
                        Elements itsLink = new_link.getElementsByTag("a");
                        String title = itsLink.attr("title");
                        String url = itsLink.attr("href");
